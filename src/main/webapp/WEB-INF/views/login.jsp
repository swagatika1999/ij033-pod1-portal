...
<script>
            function myFunction() {
                var inpObj = document.getElementById("userid");
                if (!inpObj.checkValidity()) {
                    document.getElementById("msg").innerHTML = inpObj.validationMessage;
                }

                var inpObj1 = document.getElementById("password");
                if (!inpObj.checkValidity()) {
                    document.getElementById("msg1").innerHTML = inpObj.validationMessage;
                }
            }
        </script>
					...
					<form:form action="/user/homepage" modelAttribute="usercredentials"
						...
						<div class="form-group mb-3">
							...
							<input id="userid" type="text" name="userid"
								...
								class=" rounded-pill border-0 shadow-sm px-4" required="" style="width: 300px;" /><p id="msg" style="color:red;"></p>
						</div>
						<div class="form-group mb-3">
							<label>PASSWORD:</label>
							<input id="password" type="password" name="password"
								placeholder="Password"
								class=" rounded-pill border-0 shadow-sm px-4 text-primary" required="" style="width: 300px;" /><p id="msg1" style="color:red;"></p>
						</div>

						<center><button type="submit" name="submit"  style="width:250px"
							class="btn btn-warning btn-block text-uppercase mb-2 rounded-pill shadow-sm" onclick="myFunction()">Login</button></center>
